                ...
                <script>
                    $(document).ready(function() {
                        document.getElementById('salvarPerfil').addEventListener('click', function() {
                            document.getElementById('editarPerfil').submit(); // Submete o formulário
                        });
                    });
                </script>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="config/editarUser.php" id="editarPerfil">
                                        <div class="form-group mb-3">
                                            <label for="nome">Nome:</label>
                                            <input type="text" name="nome" class="form-control" id="removerBotao" value="<?php echo $row['nome'] ?>" readonly>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="usuario">Usuário:</label>
                                            <input type="text" name="user" class="form-control adicionar editar" id="usuario" value="<?php echo $row['user']?>" readonly>
                                        </div>
                                        <input type="hidden" name="id" value="<?php echo $_SESSION['id'] ?>">
                                        <div class="form-group mb-3">
                                            <label for="email">E-mail:</label>
                                            <input type="email" name="email" class="form-control adicionar editar" id="email" value="<?php echo $row['email'] ?>" readonly>
                                        </div>
                                        <div class="form-group mb-3">
                                            <button type="button" class="btn btn-sm btn-outline-primary" id='btnEditar'>Editar</button>
                                            <input type="button" class="btn btn-sm btn-outline-primary" id="salvarPerfil" name="btn" style="display: none;" value="Salvar">
                                        </div>
                                    </form>
                                </div>
                            </div>
